<div class="block two-column-block">
    <h3 class="text-center">This is a third longer headline</h3>
    <hr style="border: none;">
    <div class="card-group text-block">
        <div class="card">
            <div class="card-block">
            <p class="card-text card-left mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
